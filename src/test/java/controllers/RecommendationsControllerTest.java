...
public class RecommendationsControllerTest extends GenericTest {
    ...
    public void getFlightsRecommendationsResponse() {
        ...
        when(us.getRecommendations(anyString())).thenReturn(Arrays.asList(recommendation));
    ...
    public void recommendFlightResponse() {
        ...
        when(us.recommendFlight(anyLong(), anyString(), anyString())).thenReturn((recommendation));
    ...
    public void acceptRecommendationsResponse() {
        ...
        when(us.acceptRecommendation(anyLong(), anyString())).thenReturn((recommendation));
    ...
    public void rejectRecommendationsResponse() {
        ...
        when(us.rejectRecommendation(anyLong(), anyString())).thenReturn((recommendation));
